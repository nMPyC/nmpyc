...
The **nMPyC** software is Python based and works therefore on any OS with a Python distribution (for more precise requiremnents see the :doc:`Installation <install>` section). 
